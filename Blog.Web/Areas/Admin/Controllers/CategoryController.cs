...
namespace Blog.Web.Areas.Admin.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Add(VMCategoryAdd vmCategoryAdd)
        {
        ...
        public async Task<IActionResult> Update(Guid categoryId)
        {
            ...
            var map = mapper.Map<Category, VMCategoryUpdate>(category);
            return View(map);
        }

        [HttpPost]
        public async Task<IActionResult> Update(VMCategoryUpdate vmCategoryUpdate)
        {
            var map = mapper.Map<Category>(vmCategoryUpdate);
            var result = await validator.ValidateAsync(map);

            if (result.IsValid) 
            { 
                var name = await categoryService.UpdateCategoryAsync(vmCategoryUpdate);
